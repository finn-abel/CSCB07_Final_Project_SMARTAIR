...
public class ProviderLoginPresenterTests {

    @Mock
    private ProviderLoginModel mockLoginModel;

    @Mock
    private ProviderLoginView mockLoginView;

    private ProviderLoginPresenter loginPresenter;

    @BeforeEach
    public void setUp() {
        loginPresenter = new ProviderLoginPresenter(mockLoginView,mockLoginModel);
    }
    ...
    void onLoginSuccess() {
        ...
        verify(mockLoginView).navigateToProviderHomeScreen();
    }
