...
public class ChildLoginPresenterTests {

    @Mock
    private ChildLoginModel mockLoginModel;

    @Mock
    private ChildLoginView mockLoginView;

    private ChildLoginPresenter loginPresenter;

    @BeforeEach
    public void setUp() {
        loginPresenter = new ChildLoginPresenter(mockLoginView,mockLoginModel);
    }
